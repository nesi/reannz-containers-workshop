...
For these exercises, we will use the [`my_python3.12.def`](https://github.com/nesi/reannz-containers-workshop/blob/main/examples/08_making_tests_in_containers/my_python3.12.def) file from Chapter 4, which builds a container with Python 3.12.
