...
![image](./fig/unix_funnel.png){width="350" .center}
...
!!! info "The UNIX operating system is made up of three parts; the ^^kernel^^, the ^^shell^^ and the programs"
    ...
    <center>
    ![image](./fig/interpreter_loop.png){width="200"}
    </center>
